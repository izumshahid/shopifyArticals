...
import { StyledDiv, StyledInput } from "../styled-components";
                            ...
                            {item.type === "question" ? (
                              <>
                                <StyledInput
                                  ...
                                  onChange={(e) => {
                                    const newItems = [...allDNDItems];
                                    newItems[idx].inputContent = e.target.value;
                                    setAllDNDItems(newItems);
                                  }}
                                  type="text"
                                />
                              ...
                              >
                                {shopifyCollections?.map(({ id, title }) => (
